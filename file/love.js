(function(window){
    ...
    Heart.prototype = {
        get: function(i, scale) {
            return this.points[i].mul(scale || 2);
        }
    }
    ...
    ctx.font = "12px Verdana";  // Increased font size for better visibility

    // Position the text relative to the heart
    ctx.fillText("Click Heart :)", -110, -60); 
